...
**[Blog App]** is classic example of a blog website. The app is fully functional website that will show the list of posts and empower readers to interact with them by adding comments and liking posts.
...
- **[Create posts]**
- **[Readers can interact adding comments and liking posts]**
...
Feel free to check the [issues page](https://github.com/dgcuenca/Blog-app/issues).
...
- **Is there an Entity Relationship Diagram (ERD) that represents this project?**
  ...
  - Yes! 
  <div align="left">
    <img src="./public/blog_app_erd_v1_1.png" alt="ERD diagram" width="540"  height="auto" />
  </div>
